...
from chatbot_py import chatbot_response
...
# ---- FIX HERE ----
# Prefer .ico (works on Windows)
try:
    root.iconbitmap(r"C:\Health Care ChatBot\Health-Care-Chatbot\MedBot.ico")  # Use .ico version of your logo
except Exception:
    # Fallback: use PhotoImage for PNG/JPG
    try:
        from tkinter import PhotoImage
        icon = PhotoImage(file=r"C:\Health Care ChatBot\Health-Care-Chatbot\MedBot.png")  # convert your jpg to png
